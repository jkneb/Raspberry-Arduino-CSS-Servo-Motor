...
function sanitizePinNumber(pinNumber) {
  console.log('isNumber =>', isNumber(pinNumber)); 
  console.log('pinMapping[%s] => %s', pinNumber, pinMapping[pinNumber]); 
...
var gpio = {
	open: function(pinNumber, direction, callback) {
		console.log('## calling open : '+pinNumber+'##');
	...
	setDirection: function(pinNumber, direction, callback) {
		console.log('## calling setDirection '+pinNumber+'##');
		pinNumber = sanitizePinNumber(pinNumber);
		direction = sanitizeDirection(direction);

		fs.writeFile(sysFsPath + "/gpio" + pinMapping[pinNumber] + "/direction", direction, function(err){
			if(err){
				callback(err, pinNumber)
			} else {
				callback(null, pinNumber);
	...
	getDirection: function(pinNumber, callback) {
		console.log('## calling getDirection '+pinNumber+'##');
		pinNumber = sanitizePinNumber(pinNumber);
	...
	close: function(pinNumber, callback) {
		console.log('## calling close '+pinNumber+'##');
		pinNumber = sanitizePinNumber(pinNumber);
	...
	read: function(pinNumber, callback) {
		console.log('## calling read '+pinNumber+'##');
		pinNumber = sanitizePinNumber(pinNumber);
	...
	write: function(pinNumber, value, callback) {
		console.log('## calling write '+pinNumber+'##');
		pinNumber = sanitizePinNumber(pinNumber);
